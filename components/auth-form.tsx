  ...
  return (
    <Card className="w-full shadow-lg">
      <CardHeader className="text-center">
        ...
        <CardDescription>
          {isLogin ? "Sign in to your account to continue" : "Join us and start planning your perfect trip"}
        </CardDescription>
      </CardHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {!isLogin && (
            <div className="space-y-2">
              ...
              {passwordsMatch && !errors.confirmPassword && <p className="text-sm text-green-600">Passwords match!</p>}
            </div>
          )}
